# Mouse Cursor Control Using Facial Movements [![](https://img.shields.io/hexpm/l/plug.svg)](https://github.com/akshaychandra21/Mouse_Cursor_Control_Handsfree/blob/master/LICENSE)
...
You can get the trained model file from http://dlib.net/files, click on **shape\_predictor\_68\_face\_landmarks.dat.bz2**. The model dat file has to be in the project folder.
